...
def build_buttons(cfg=None, *, tx_hash="EXAMPLETXHASH", buyer="rEXAMPLEaddress"):
    ...
    return InlineKeyboardMarkup([
        [
            InlineKeyboardButton(cfg["button_tx"], url=cfg["link_tx"].format(tx_hash=tx_hash)),
            InlineKeyboardButton(cfg["button_buyer"], url=cfg["link_buyer"].format(buyer=buyer)),
            InlineKeyboardButton(cfg["button_chart"], url=cfg["link_chart"]),
        ],
        [
            InlineKeyboardButton(cfg["button_xmag"], url=cfg["link_xmag"]),
            InlineKeyboardButton(cfg["button_buy"], url=cfg["link_buy"])
        ]
    ])
